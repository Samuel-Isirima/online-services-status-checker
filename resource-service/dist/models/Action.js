...
ActionSchema.methods.getResponse = function () {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield InterestedResponse_1.default.findOne({ _id: this.response_id });
        return response;
    });
};
const Action = mongoose_1.default.model('actions', ActionSchema); //, 'Action_service_database');
