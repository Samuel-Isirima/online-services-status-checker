...
authRouter.post('/register', body_parser_1.default.urlencoded(), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var user = null;
    ...
    if (validationResult.status === false) {
        const errorMessages = extractValidationErrorMessages(validationResult.errors);
    ...
    user = yield User_1.default.findOne({ where: { email: req.body.email } });
    if (user) {
